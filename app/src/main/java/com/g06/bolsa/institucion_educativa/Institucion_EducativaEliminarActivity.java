...
public class Institucion_EducativaEliminarActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_institucion_educativa_eliminar);
        DBHelper = new ControlInstitucionEducativa(this);
        IdInstitucion = findViewById(R.id.editIdEliminarInstitucion);
        IdDepartamento = findViewById(R.id.editIdDepartamentoEliminarInstitucion);
        NombreInstitucion = findViewById(R.id.editNombreEliminarInstitucion);
    }
    ...
    public void eliminarInstitucion(View v) {
        ...
        DBHelper.abrir();
        regEliminadas = DBHelper.eliminarInstitucionEducativa(ie);
        DBHelper.cerrar();

        Toast.makeText(this, regEliminadas, Toast.LENGTH_SHORT).show();
    }

    public void consultarEliminarInstitucion(View v) {
        DBHelper.abrir();
    ...
    public void limpiarEliminarInstitucion(View v) {
